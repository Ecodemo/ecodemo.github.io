// ==UserScript== 
// @name   搜索跳转修复版
// @description  方便的在各个引擎之间跳转。可自定义搜索列表的 NL修改版。
// @match   /^https?:\/\/(?:www|encrypted)\.google(?:stable)?\..{2,9}\/(?:webhp|search|#|$|\?)(?:.(?!tbm=))*$/
// @match   /^https?:\/\/www\.baidu\.com\/(?:s|baidu|)/
// @match   /^https?:\/\/[^.]*\.bing\.com\/search/
// @match   /^https?:\/\/www\.so\.com\/s\?/
// @match   /^https?:\/\/www\.sogou\.com\/(?:web|sogou)/
// @match   /^https?:\/\/.*\.*search\.yahoo\.com\/search/
// @match   /^https?:\/\/.*\.*search\.yahoo\.co.jp\/search/
// @match   /^https?:\/\/(www\.)?duckduckgo\.com\/\?(.+&)?q=/
// @match   /^https?:\/\/(www\.)?yandex\..+\/search\/\?(.+&)?text=/
// @match   /^https?:\/\/scholar\.google(?:\.\D{1,3}){1,2}\/scholar\?/
// @match   /^https?:\/\/baike\.baidu\.com\/((sub)?view)?(item)?(search)?/
// @match   /^https?:\/\/[a-z]{2,3}\.baike\.com\/[a-z]/
// @match   /^https?:\/\/..\.wikipedia\.org\/w\/index\.php\?(?=.*search=)/
// @match   /^https?:\/\/zhidao\.baidu\.com\/search/
// @match   /^https?:\/\/tieba\.baidu\.com\/f/
// @match   /^https?:\/\/zhidao\.baidu\.com\/(question|link)/
// @match   /^https?:\/\/www\.zhihu\.com\/search\?/
// @match   /^https?:\/\/wenku\.baidu\.com\/search\?/
// @match   /^https?:\/\/www\.docin\.com\/search\.do/
// @match   /^https?:\/\/www\.soku\.com\/[a-z]/
// @match   /^https?:\/\/www\.douban\.com\/search\?/
// @match   /^https?:\/\/movie\.douban\.com\/subject_search\?/
// @match   /^https?:\/\/book\.douban\.com\/subject_search\?/
// @match   /^https?:\/\/www\.duokan\.com\/search\//
// @match   /^https?:\/\/(?:www|encrypted)\.google(?:stable)?\..{2,9}\/(?:webhp|search|#|$|\?)(.*tbm=bks)/
// @match   /^https?:\/\/www\.bilibili\.com\/search\?/
// @match   /^https?:\/\/www\.acfun\.tv\/search/
// @match   /^https?:\/\/www\.youtube\.com\/results/
// @match   /^https?:\/\/www\.nicovideo\.jp\/search\//
// @match   /^https?:\/\/(?:v|(?:video))\.baidu\.com\/(?:v|#)/
// @match   /^https?:\/\/video\.so\.com\//
// @match   /^https?:\/\/v\.qq\.com\/search\.html\?/
// @match   /^https?:\/\/v\.sogou\.com\/v\?/
// @match   /^https?:\/\/.*\.bing\.com\/video/
// @match   /^https?:\/\/so\.iqiyi\.com\/so\/q/
// @match   /^https?:\/\/so\.letv\.com\/s\?/
// @match   /^https?:\/\/so\.tv\.sohu\.com\/mts\?/
// @match   /^https?:\/\/so\.56\.com\/video\//
// @match   /^https?:\/\/so\.ku6\.com\/search/
// @match   /^https?:\/\/www\.dongting\.com\/#/
// @match   /^https?:\/\/music\.baidu\.com\/search/
// @match   /^https?:\/\/cgi\.music\.soso\.com/
// @match   /^https?:\/\/mp3\.sogou\.com\/music\.so/
// @match   /^https?:\/\/so\.yinyuetai\.com\/mv\?/
// @match   /^https?:\/\/so\.1ting\.com\//
// @match   /^https?:\/\/www\.songtaste\.com\/search/
// @match   /^https?:\/\/www\.xiami\.com\/search/
// @match   /^https?:\/\/music\.163\.com\/.*#\/search/
// @match   /^https?:\/\/sou\.kuwo\.cn\/ws\/NSearch/
// @match   /^https?:\/\/\w{2,10}\.google(?:\.\D{1,3}){1,2}\/search\?(.*tbs=sbi)|(.*tbm=isch)/
// @match   /^https?:\/\/image\.baidu\.c(om|n)\/(i|search)/
// @match   /^https?:\/\/\image\.so\.com\/i\?/
// @match   /^https?:\/\/.*\.bing\.com\/images\/search/
// @match   /^https?:\/\/pic\.sogou\.com\/pic/
// @match   /^https?:\/\/image\.youdao\.com\/search/
// @match   /^https?:\/\/huaban\.com\/search\/\?/
// @match   /^https?:\/\/www\.flickr\.com\/search/
// @match   /^http:\/\/(..|...)\.picsearch\.com\/index\.cgi/
// @match   /^http:\/\/www\.pixiv\.net\/search\.php/
// @match   /^http:\/\/www\.deviantart\.com\/browse\/all\/\?q/
// @match   /^http:\/\/www\.easyicon\.net\/iconsearch\//
// @match   /^http:\/\/img\.jpg4\.info\//
// @match   /^https?:\/\/www\.allyingshi\.com\/index\/search\//
// @match   /^https?:\/\/bt\.ktxp\.com\/search\.php\?/
// @match   /^http:\/\/cili006\.com\/\?topic_title/
// @match   /^https?:\/\/share\.dmhy\.org\/topics\/list/
// @match   /^https?:\/\/kat\.cr\/usearch\//
// @match   /^https?:\/\/www\.nyaa\.se\/\?page/
// @match   /^https?:\/\/www\.ed2000\.com\/FileList\.asp/
// @match   /^https?:\/\/search\.t\.qq\.com\/index\.php\?(.*QQ%E6%97)/
// @match   /^https?:\/\/(www\.)?btso\.pw\/search/
// @match   /^https?:\/\/(www\.)?thepiratebay\.org\/search\//
// @match   /^https?:\/\/www\.breadsearch\.com\/search/
// @match   /^https?:\/\/www\.cilibaba\.com\/search\//
// @match   /^https?:\/\/www\.bthave\.cc\/search\//
// @match   /^https?:\/\/(www\.)?btku\.org\/q\//
// @match   /^https?:\/\/(www\.)?torrentkitty\.(com|org|net|tv)\/search\//
// @match   /^https?:\/\/btdigg\.org\/search\?/
// @match   /^https?:\/\/s8?\.etao\.com\/search/
// @match   /^https?:\/\/search\.jd\.com\/Search\?/
// @match   /^https?:\/\/s\.taobao\.com\/search/
// @match   /^https?:\/\/s\.1688\.com\/(((selloffer|company|newbuyoffer|wiki)\/)|([a-z]+\/[a-z]+_search))/
// @match   /^https?:\/\/searchex\.yixun\.com\/html\?/
// @match   /^https?:\/\/(search)\.suning\.com\//
// @match   /^https?:\/\/list\.tmall\.com\/\/?search/
// @match   /^https?:\/\/www\.amazon\.((cn)|(com))\/s\/ref/
// @match   /^https?:\/\/search\.dangdang\.com\/\?key/
// @match   /^https?:\/\/s\.paipai\.com\/[a-z]/
// @match   /^https?:\/\/se?\.wanggou\.com\/[a-z]/
// @match   /^https?:\/\/s\.mall\.360\.cn\/search/
// @match   /^https?:\/\/www\.huihui\.cn\/search\?/
// @match   /^https?:\/\/dict\.youdao\.com\/search/
// @match   /^https?:\/\/www\.iciba\.com/
// @match   /^https?:\/\/dict\.cn\/./
// @match   /^https?:\/\/dict\.hjenglish\.com\/(en|w)/
// @match   /^https?:\/\/dict\.hjenglish\.com\/(404\/)?jp/
// @match   /^https?:\/\/www\.zdic\.net\/sousuo/
// @match   /^https?:\/\/translate\.google\./
// @match   /^https?:\/\/fanyi\.baidu\.com/
// @match   /^https?:\/\/fanyi\.youdao\.com/
// @match   /^https?:\/\/(cn|www)\.bing\.com\/dict\/search\?/
// @match   /^https?:\/\/www\.bing\.com\/translator/
// @match   /^https?:\/\/fy\.iciba\.com/
// @match   /^https?:\/\/search\.t\.qq\.com\/index|user\.php\?/
// @match   /^https?:\/\/s\.weibo\.com\/weibo|user\//
// @match   /^https?:\/\/www\.facebook\.com\/search\//
// @match   /^https?:\/\/(www\.)?twitter\.com\/search/
// @match   /^https?:\/\/plus\.google\.com\/s\//
// @match   /^https?:\/\/shooter\.cn\/search/
// @match   /^https?:\/\/www\.subom\.net\/search/
// @match   /^https?:\/\/vdisk\.weibo\.com\/search/
// @match   /^https?:\/\/(?:www|encrypted|cse)\.google(?:stable)?\..{2,9}\/(?:cse\?)(.*q=)/
// @match   /^http:\/\/www\.javlibrary\.com\/[a-z]{2}\/.*search/
// @match   /^http:\/\/www\.javlibrary\.com\/[a-z]{2}\/\?v/
// @match   /^http:\/\/www\.javmoo\.xyz\/[a-z]{2}\/search/
// @match   /^http:\/\/www\.javmoo\.xyz\/[a-z]{2}\/movie/
// @match   /^http:\/\/www\.avless\.com\/[a-z]{2}\/search/
// @match   /^http:\/\/www\.avless\.com\/[a-z]{2}\/movie/
// @match   /^http:\/\/www\.avmemo\.com\/[a-z]{2}\/search/
// @match   /^http:\/\/www\.avmemo\.com\/[a-z]{2}\/movie/
// @match   /^https?:\/\/www\.javbus\.com\/((search\/)|(uncensored\/)|(searchstar\/))/
// @match   /^https?:\/\/www\.javbus\.com\/[A-Za-z0-9-]+$/
// @match   /^http:\/\/(www\.)?avdb\.la\/search/
// @match   /^http:\/\/(www\.)?avdb\.la\/movie/
// @match   /^http:\/\/www\.avdb\.im\/([a-z]{2}\/)?search/
// @match   /^http:\/\/www\.avdb\.im\/([a-z]{2}\/)?movie/
// @match   /^http:\/\/www\.libredmm\.com\//
// @match   /^http:\/\/www\.pornmd\.com\//
// @match   /^http:\/\/www\.pornhub\.com\/.*search/
// @match   /^http:\/\/www\.xtube\.com\/.*search/
// @match   /^http:\/\/www\.redtube\.com\/.*search/
// @match   /^http:\/\/www\.youporn\.com\/.*search/
// @match   /^http:\/\/www\.keezmovies\.com\/.*search/
// @match   /^http:\/\/www\.tube8\.com\/.*search/
// @match   /^http:\/\/www\.spankwire\.com\/.*search/
// @match   /^http:\/\/www\.extremetube\.com\/.*search/
// @match   /^http:\/\/www\.dmm\.[\w\.]+\/.*search/
// @match   /^http:\/\/www\.oisinbosoft\.[\w\.]+\/.*seach/
// @match   /^http:\/\/www\.minnano\-av\.[\w\.]+\/.*search/
// @match   /^https?:\/\/www\.fakku\.net\/.*search/
// @match   /^https?:\/\/www\.zerochan\.net\//
// @match   /^https?:\/\/\w*\.?pururin\.com\/search/
// @match   /^https?:\/\/\w*\.?donmai\.us\/.*(search|tags)/
// @match   /^https?:\/\/\w*\.?gelbooru\.com\/.*(search|tags)/
// @match   /^https?:\/\/\w*\.?konachan\.com\/.*(search|tags)/
// @match   /^https?:\/\/\w*\.?yande\.re\/.*(search|tags)/
// @match   /^https?:\/\/\w*\.?rule34\.xxx\/.*(search|tags)/
// @match   /^https?:\/\/\w*\.?lolibooru\.moe\/.*(search|tags)/
// @match   /^https?:\/\/\w*\.?safebooru\.org\/.*(search|tags)/
// @match   /^https?:\/\/\w*\.?sankakucomplex\.com\/.*(search|tags)/
// @match   /^https?:\/\/\w*\.?behoimi\.org\/.*(search|tags)/
// @match   /^http:\/\/www\.sokmil\.com\/.*search/
...
//    },
    ...
    {name: "DuckDuckGo",
        ...
        target: 'css;.header__search-wrap',
        where: 'afterEnd'
        }
    },
    {name: "Yandex",
        url: /^https?:\/\/(www\.)?yandex\..+\/search\/\?(.+&)?text=/,
        engineList: '网页',
        enabled: true,
        style: "\
        padding-left: 30px;\
...
//    },
    ...
    {name: "btspread",
		...
		style: '\
			   ...
			   ',
		insertIntoDoc: {
		   keyword: 'css;.form-inline .form-control',
		   target: 'css;.form-inline',
		   where: 'afterEnd'
		}
    },
    {name: "thepiratebay",
		url: /^https?:\/\/(www\.)?thepiratebay\.org\/search\//,
		enabled: true,
		engineList: "download",
		style: '\
			   word-break:keep-all;\
    ...
    {name: "BtBook",
		url: /^https?:\/\/www\.bthave\.cc\/search\//,
		enabled: true,
		engineList: "download",
        style: '\
               margin:0 auto;\
    ...
    {name: "torrentkitty",
        url: /^https?:\/\/(www\.)?torrentkitty\.(com|org|net|tv)\/search\//,
        enabled: true,
        engineList: "download",
        style: '\
               border-top:1px solid #FFFFFF;\
    ...
    {name: "1688",
        url: /^https?:\/\/s\.1688\.com\/(((selloffer|company|newbuyoffer|wiki)\/)|([a-z]+\/[a-z]+_search))/,
        enabled: true,
        engineList: "购物",
        style: "\
           border-bottom: 1px solid #E5E5E5;\
    ...
    {name: "JAVBus(搜索页)",
        url: /^https?:\/\/www\.javbus\.com\/((search\/)|(uncensored\/)|(searchstar\/))/,
        engineList: "adult",
        enabled: true,
        style: "\
            margin: 0 auto;\
        ...
        insertIntoDoc: {
            //keyword: 'css;input[name=word]',
            keyword: function() {
               var hr = document.querySelector('.search-header .active a').href
               var ma = hr.match(/search\/(.+)&type=1/);
               if (ma) { var str = ma[1]; }
               else { var str = hr.match(/searchstar\/(.+)$/)[1]; }
               //var str = document.title;
               //    document.write(str+"</br>");
	           //str=str.match(/^[\w-]+ /);
    ...
    {name: "JAVBus(结果页)",
        url: /^https?:\/\/www\.javbus\.com\/[A-Za-z0-9-]+$/,
        engineList: "adult",
        enabled: true,
        style: "\
            margin: 0 auto;\
    ...
    div.innerHTML = '\
        ...
        <ul>\
            ...
            <li>\
                ...
                <a style="margin-left: 20px;" target="_blank" href="https://github.com/tangxiadi/searchEngineJumpSU/issues" title="通过反馈给作者加入你的版本">加入你的版本？</a>\
            </li>\
            <li>自定义搜索列表：\
