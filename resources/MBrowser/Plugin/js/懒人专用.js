// ==UserScript== 
// @name   懒人专用
// @description  懒人专用，全网VIP视频免费破解去广告、全网音乐直接下载、百度网盘直接下载、知乎视频下载等多合一版。长期更新，放心使用。
// @run-at   document-end
// ==/UserScript==
// ==UserScript==
...
!function () {
    ...
    function a() {
        ...
        function T() {
            ...
            T.click(X), i.append(y).append(d).append(h).append(T), t.append(e).append(i), t.hover(function () {
    ...
    function o() {
        ...
        function g() {
            ...
            n.append(l).append(d).append(r).append(c).append(o), e.append(i), t.append(e).append(n), t.hover(function () {
                t.toggleClass("button-open");
