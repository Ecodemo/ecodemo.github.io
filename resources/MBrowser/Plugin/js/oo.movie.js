...
// @version      20.2.9
// @description  VIP视频解析 + 豆瓣影视页净化。精选VIP解析，视频少广告，原网页解析，享受VIP的原画观影体验。手机端与电脑端通用。支持腾讯视频、爱奇艺、优酷、芒果TV、搜狐视频、PPTV、1905、乐视、土豆等网站。VIP解析评分排序，不同网站不同排序，越好用的解析越靠前。
// @author       (o˘◡˘o)
